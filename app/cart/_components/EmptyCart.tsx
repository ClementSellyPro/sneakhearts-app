...
export default function EmptyCart() {
  return (
    <div className="h-screen px-6 md:px-24 lg:px-48 py-12 md:py-18 w-full">
      <div className="flex flex-col md:flex-row justify-baseline md:justify-between gap-18 pb-12">
